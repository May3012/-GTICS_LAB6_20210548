package com.example.labdejavier.config;
...
public class SecurityConfig {
    ...
    public UserDetailsManager users(DataSource dataSource){
        ...
        String sql1="select correo,contrasena,activo from usuarios where correo=?";
        String sql2="select u.correo,r.nombre_rol from usuarios u inner join rol r on u.idRol=r.id_rol where u.correo=? and u.activo=1";
