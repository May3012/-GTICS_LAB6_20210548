...
public interface MesaRepository {
    ...
    void agregarMesa(String nombre,Integer cantidad);

    @Transactional
    @Modifying
    @Query(nativeQuery = true,value = "update mesa set nombre=?2,disponibilidad=disponibilidad-(cantidad-?3),cantidad=?3 where id_dispositivo=?1")
